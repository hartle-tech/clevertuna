    ...
    static func write(to path: String, args: [String]) {
        ...
        Task { @MainActor in
            ...
            do {
                ...
                // A rolled look is the subject of the render: hold it against
                // the read the builder does when it appears, or a render "at
                // seed 7" is really a render of whatever the keyboard happens
                // to be showing.
            ...
            let surface = args.firstIndex(of: "--surface").flatMap { i -> String? in
            ...
            let size: NSSize
            switch surface {
            case "prompt": size = NSSize(width: 420, height: kind == "slot" ? 520 : 280)
